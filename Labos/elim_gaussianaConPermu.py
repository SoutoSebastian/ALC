...
matrizEjemplo5 = np.array([[0.3,0,0.1],[0.05,1.0,0.2],[0.1,0.15,0.1]])
...
########FUNCION INVERSA##########
#Lo hice para ver si daba bien, usando las funciones del labo, back_substitution no tiene nada raro y escalonar filas es dudosa pero la podemos hacer usando
